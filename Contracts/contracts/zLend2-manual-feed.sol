...
contract zLend2Manual is Ownable, ReentrancyGuard {
    ...
    struct Token {
        ...
        uint256 LTV; // Loan-to-Value (LTV) Ratio, Lower is better
        uint256 stableRate;
    ...
    function addTokensForLending(
        ...
        Token memory token = Token(tokenAddress, LTV, borrowStableRate,interestRate, name);
